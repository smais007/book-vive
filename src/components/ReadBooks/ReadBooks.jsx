              ...
              >
                <div className="px-4 py-6 sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:p-8">
                  <div className="sm:flex lg:col-span-7">
                    ...
                    <img src={book.image} alt="" className="rounded-lg shadow-lg h-80 w-96 " />
                    </div>
                    ...
                    <div className="mt-6 sm:ml-6 sm:mt-0">
                      ...
                      <div className="flex flex-wrap gap-3">
                            ...
                            <div className="mt-3">Year Of Publishing {book.yearOfPublishing}</div>
                      ...
                      {/* <div className="flex">
                       ...
                       <div className="flex gap-3 my-3">
                        <div>
                       <button className="bg-blue-200 self-start px-5 py-2 text-sm rounded-3xl text-gray-900">Catagory {book.category}</button>
                       </div> <div>
                       <button className="bg-orange-200 self-start px-5 py-2 text-sm  rounded-3xl text-gray-900">Rating {book.rating}</button>
                       </div>
                      <div>
                      <Link to={`/${book.bookId}`}>
